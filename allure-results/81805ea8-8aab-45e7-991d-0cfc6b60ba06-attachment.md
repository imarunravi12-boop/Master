...
- Name: demo-todo-app.spec.ts >> Routing >> should allow me to display completed items
- Location: tests\demo-todo-app.spec.ts:378:7
...
Call log:
  - waiting for getByRole('link', { name: 'Completed' })
    - locator resolved to <a class="" href="#/completed">Completed</a>
